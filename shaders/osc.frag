...
DEFINE_OUTPUT_2(cosine, DESC("cosine wave"))
DEFINE_OUTPUT_3(sawtooth, DESC("sawtooth wave"))
DEFINE_OUTPUT_4(arcsine, DESC("anti sine wave"))
...
void main() {
    ...
    output_cosine(amp * (0.5 * cos(x) + 0.5));
